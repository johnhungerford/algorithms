 ...
 * O(logN) time complexity. O(1) additional space complexity.
...
function binarySearch(a, n, lo, hi, opt1, opt2) {
    const opt = opt === undefined? 0 : opt === 1 ? 1 : 0;
    const opt2 = opt2 === undefined? 0 : opt2 === 1 ? 1 : opt2 === 2 ? 2 : 0;
    while (true) {
        if (a[lo] === n) if (opt === 0 || (opt === 1 && a[lo + 1] !== n)) return lo;
        if (a[hi] === n) if (opt === 1 || (opt === 0 && a[hi - 1] !== n)) return hi;
